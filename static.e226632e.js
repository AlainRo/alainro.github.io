...
function startPreloader() {
  if (typeof document !== 'undefined') {
    ...
    (0, _Mutation.default)(function () {
      var els = [].slice.call(document.querySelectorAll('a[href]'));
...
/* harmony import */ var react_universal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
...
Object(react_universal_component__WEBPACK_IMPORTED_MODULE_2__["setHasBabelPlugin"])();var universalOptions={loading:function loading(){return null;},error:function error(props){console.error(props.error);return React.createElement("div",null,"An error occurred loading this page's template. More information is available in the console.");}};var t_0=react_universal_component__WEBPACK_IMPORTED_MODULE_2___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({id:"../src/pages/404.js",load:function load(){return Promise.all([Promise.resolve(/* import() | src-pages-404 */).then(__webpack_require__.bind(null, 39))]).then(function(proms){return proms[0];});},path:function path(){return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname,'../src/pages/404.js');},resolve:function resolve(){return /*require.resolve*/(39);},chunkName:function chunkName(){return"src-pages-404";}}),universalOptions);var t_1=react_universal_component__WEBPACK_IMPORTED_MODULE_2___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({id:"../src/pages/about.js",load:function load(){return Promise.all([Promise.resolve(/* import() | src-pages-about */).then(__webpack_require__.bind(null, 40))]).then(function(proms){return proms[0];});},path:function path(){return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname,'../src/pages/about.js');},resolve:function resolve(){return /*require.resolve*/(40);},chunkName:function chunkName(){return"src-pages-about";}}),universalOptions);var t_2=react_universal_component__WEBPACK_IMPORTED_MODULE_2___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({id:"../src/pages/blog.js",load:function load(){return Promise.all([Promise.resolve(/* import() | src-pages-blog */).then(__webpack_require__.bind(null, 41))]).then(function(proms){return proms[0];});},path:function path(){return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname,'../src/pages/blog.js');},resolve:function resolve(){return /*require.resolve*/(41);},chunkName:function chunkName(){return"src-pages-blog";}}),universalOptions);var t_3=react_universal_component__WEBPACK_IMPORTED_MODULE_2___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({id:"../src/containers/Post",load:function load(){return Promise.all([Promise.resolve(/* import() | src-containers-Post */).then(__webpack_require__.bind(null, 44))]).then(function(proms){return proms[0];});},path:function path(){return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname,'../src/containers/Post');},resolve:function resolve(){return /*require.resolve*/(44);},chunkName:function chunkName(){return"src-containers-Post";}}),universalOptions);var t_4=react_universal_component__WEBPACK_IMPORTED_MODULE_2___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({id:"../src/pages/index.js",load:function load(){return Promise.all([Promise.resolve(/* import() | src-pages-index */).then(__webpack_require__.bind(null, 43))]).then(function(proms){return proms[0];});},path:function path(){return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname,'../src/pages/index.js');},resolve:function resolve(){return /*require.resolve*/(43);},chunkName:function chunkName(){return"src-pages-index";}}),universalOptions);var t_5=react_universal_component__WEBPACK_IMPORTED_MODULE_2___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({id:"../src/pages/qui.js",load:function load(){return Promise.all([Promise.resolve(/* import() | src-pages-qui */).then(__webpack_require__.bind(null, 42))]).then(function(proms){return proms[0];});},path:function path(){return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname,'../src/pages/qui.js');},resolve:function resolve(){return /*require.resolve*/(42);},chunkName:function chunkName(){return"src-pages-qui";}}),universalOptions);var template404ID=0;// Template Map
...
/* harmony import */ var _material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
...
var CardMedia_ = __webpack_require__(50);
...
var notebook_runtime_ = __webpack_require__(11);

// EXTERNAL MODULE: external "how-to-embed-a-notebook-in-a-react-app"
var external_how_to_embed_a_notebook_in_a_react_app_ = __webpack_require__(46);
...
var external_perception_illusion_part_i_ = __webpack_require__(47);
...
var external_hackaviz_toulouse_2018_ = __webpack_require__(48);
...
var external_react_jsx_parser_ = __webpack_require__(49);
...
(0, _browser.registerTemplates)(_templates.default);

if (typeof document !== 'undefined' && module && module.hot) {
  module.hot.accept('react-static/templates', function () {
    (0, _browser.registerTemplates)(__webpack_require__(33).default);
  });
}
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(2)(module)))
...
var trigger = function trigger() {
  ...
  return subscribers.forEach(function (s) {
    return s.apply(void 0, args);
  });
};

function onMutation(cb) {
  subscribers.push(cb);
  return function () {
...
(function () {
  ...
  reactHotLoader.register(config, "config", "/Users/tannerlinsley/GitHub/react-static/packages/react-static/src/browser/utils/Mutation.js");
  reactHotLoader.register(subscribers, "subscribers", "/Users/tannerlinsley/GitHub/react-static/packages/react-static/src/browser/utils/Mutation.js");
  reactHotLoader.register(trigger, "trigger", "/Users/tannerlinsley/GitHub/react-static/packages/react-static/src/browser/utils/Mutation.js");
  reactHotLoader.register(onMutation, "onMutation", "/Users/tannerlinsley/GitHub/react-static/packages/react-static/src/browser/utils/Mutation.js");
  leaveModule(module);
})();
...
var _Location = _interopRequireDefault(__webpack_require__(38));
...
function (_React$Component) {
  ...
  function RouteData() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(RouteData).apply(this, arguments));
  }
...
function (_React$Component) {
  ...
  function Router(props) {
    ...
    if ("production" === 'production' && staticInfo) {
      var path = staticInfo.path,
          allProps = staticInfo.allProps,
          sharedPropsHashes = staticInfo.sharedPropsHashes,
      ...
      Object.keys(sharedPropsHashes).forEach(function (propKey) {
        _.propsByHash[sharedPropsHashes[propKey]] = allProps[propKey];
...
exports.default = exports.RouterScroller = void 0;
...
var _jsxFileName = "/Users/tannerlinsley/GitHub/react-static/packages/react-static/src/browser/components/HashScroller.js";
...
var _default = function _default(props) {
  return _react.default.createElement(_router.Location, {
    ...
    return _react.default.createElement(RouterScroller, _extends({}, location, props, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 76
      },
...
(function () {
  ...
  reactHotLoader.register(_default, "default", "/Users/tannerlinsley/GitHub/react-static/packages/react-static/src/browser/components/HashScroller.js");
  leaveModule(module);
})();
...
var Tabs_ = __webpack_require__(45);
